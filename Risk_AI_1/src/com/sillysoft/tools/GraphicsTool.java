...
public static void drawArrowImageConnectingPoints(Graphics2D g, Point from, Point to, boolean doubleArrow)
	{
	if (from.x == 706 && from.y == 174 && to.x == 64 && to.y == 148)
		{	// special case, kam to alaska
		to = new Point(810, 174);
		}
	else if (from.x == 64 && from.y == 148 && to.x == 706 && to.y == 174)
		{	// special case, alaska to kam
		to = new Point(-4, 148);
		}		
